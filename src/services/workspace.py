...
def _build_soul_instructions(additional_prompt: str | None) -> str:
    """Load SOUL.md template from disk and inject the workspace system_prompt."""
    tmpl = (_AGENT_FILES_DIR / "SOUL.md").read_text()
    return tmpl.replace("{additional_prompt}", additional_prompt or "")
